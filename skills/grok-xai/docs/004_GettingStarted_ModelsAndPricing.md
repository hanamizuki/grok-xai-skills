...
**[Document Search](/docs/guides/files)**
...
The advanced agentic search capabilities powering grok.com are generally available in the new [**agentic tool calling API**](/docs/guides/tools/overview), and the Live Search API but will be deprecated by _January 12, 2026_.
