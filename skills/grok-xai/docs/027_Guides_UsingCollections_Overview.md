...
**Looking for Files?** If you want to attach files directly to chat messages for conversation context, see [Files](/docs/guides/files). Collections are different—they provide persistent document storage with semantic search across many documents.
...
*   [Using the Console →](/docs/guides/using-collections/console) - Create collections and upload documents through the xAI Console interface
*   [Using the API →](/docs/guides/using-collections/api) - Programmatically manage collections with the SDK and REST API