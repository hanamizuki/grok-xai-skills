...
# [Consumption and Rate Limits](#consumption-and-rate-limits)
...
## [Basic unit to calculate consumption — Tokens](#basic-unit-to-calculate-consumption--tokens)
...
![Tokenizer in xAI Console](/_next/image?url=%2Fassets%2Fdocs%2Fconsumption-and-rate-limits%2Fconsole-tokenizer.png&w=3840&q=75)
...
![Tokenized result for 'Flint, Michigan'](/_next/image?url=%2Fassets%2Fdocs%2Fconsumption-and-rate-limits%2Ftoken1.png&w=3840&q=75)
...
![Tokenized paragraph](/_next/image?url=%2Fassets%2Fdocs%2Fconsumption-and-rate-limits%2Ftoken2.png&w=3840&q=75)
...
### [Image prompt tokens](#image-prompt-tokens)
...
### [Estimating consumption with tokenizer on xAI Console or through API](#estimating-consumption-with-tokenizer-on-xai-console-or-through-api)
...
!['How is the weather today?' in Tokenizer on xAI Console](/_next/image?url=%2Fassets%2Fdocs%2Fconsumption-and-rate-limits%2Ftokenizer.png&w=3840&q=75)
