...
## [How Files Work with Chat](#how-files-work-with-chat)
...
## [Understanding Document Search](#understanding-document-search)
...
### [Token Usage with Files](#token-usage-with-files)
