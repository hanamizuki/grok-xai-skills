...
![Function call request/response flow example](/_next/image?url=%2Fassets%2Fdocs%2Fguides%2Ffunction-calling%2Ffunction-call.png&w=640&q=75)
...
![Local computer/server setup for function calling](/_next/image?url=%2Fassets%2Fdocs%2Fguides%2Ffunction-calling%2Flocal-server.png&w=3840&q=75)
...
### [Preparation - Define tool functions and function mapping](#preparation---define-tool-functions-and-function-mapping)
...
### [1\. Send initial message](#1-send-initial-message)
...
![Function call new request body](/_next/image?url=%2Fassets%2Fdocs%2Fguides%2Ffunction-calling%2Fnew-request-body.png&w=640&q=75)
...
### [2\. Run tool functions if Grok asks for tool call and append function returns to message](#2-run-tool-functions-if-grok-asks-for-tool-call-and-append-function-returns-to-message)
...
![Request body after processing tool call](/_next/image?url=%2Fassets%2Fdocs%2Fguides%2Ffunction-calling%2Fresponding-request-body.png&w=640&q=75)
...
### [3\. Send the tool function returns back to the model to get the response](#3-send-the-tool-function-returns-back-to-the-model-to-get-the-response)
...
### [4\. (Optional) Continue the conversation](#4-optional-continue-the-conversation)
...
## [Complete Example with Vercel AI SDK](#complete-example-with-vercel-ai-sdk)
