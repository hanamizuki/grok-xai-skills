...
\- Supply an `Authorization: Bearer Token <XAI_API_KEY>` in the request header. You can get a new API key on [xAI Console](https://console.x.ai).
...
\- Check your request body and endpoint URL with our [API Reference](api-reference).
...
\- Check your request method with our [API Reference](api-reference).

415  
Unsupported Media Type

All Endpoints Supporting `POST` Method
...
\- Check your request body is valid. You can find more information from [API Reference](api-reference).
...
\- Reduce your request rate or increase your rate limit. You can find your current rate limit on [xAI Console](https://console.x.ai).

### [2XX Error Codes](#2xx-error-codes)
...
If you believe you have encountered a bug and would like to contribute to our development process, [email API Bug Report](mailto:support@x.ai?subject=API%20Bug%20Report) to [support@x.ai](mailto:support@x.ai) with your API request and response and relevant logs.
